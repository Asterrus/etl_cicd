...
async def insert_product(
    ...
    q = text(
        "INSERT INTO source.Products (product_name, category) VALUES (:product_name, :category) RETURNING product_id"
    )
...
async def insert_customer(
    ...
    q = text(
        "INSERT INTO source.Customers (name, email, phone) VALUES (:name, :email, :phone) RETURNING customer_id"
    )
    res = await session.execute(
        q,
        {
